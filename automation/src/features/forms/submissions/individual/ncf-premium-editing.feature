...
Feature: New User order form submission for Premium Editing

    Background: I am on new user form
        Given I open the eos "/order/ncf" and wait for load

    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in wc loop for ENG partner
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in wc loop for CHN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I set <wordCount> to the inputfield //div[@class='input-box']/input
        When I click on the element //div[contains(@class,'enter-word-count')]/button
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in wc loop for JPN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I set <wordCount> to the inputfield //div[@class='input-box']/input
        When I click on the element //div[contains(@class,'enter-word-count')]/button
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in wc loop for KOR partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //button[contains(@data-description,'2-1-select') and @angularticslabel='top cta']
        When I set <wordCount> to the inputfield //div[@class='input-box']/input
        When I click on the element //div[contains(@class,'enter-word-count')]/button
        When I click on the element //label[@for='select-plan-2-day-delivery']
        When I click on the element //button[@angularticsaction="proceedFromPlanSection"]
        When I click on the element //button[@angularticsaction="proceedFromAddonSection"]
        When I set <first name> to the inputfield //input[@id='field_client_profile_firstname']
        When I set <last name> to the inputfield //input[@id='field_client_profile_lastname']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc send quote loop for ENG partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='clickDocumentNotReady']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc send quote loop for CHN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I set <email> to the inputfield //input[@id='email_id']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc send quote loop for JPN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc send quote loop for KOR partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //button[contains(@data-description,'2-1-select') and @angularticslabel='top cta']
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I click on the element //app-phoenix-plan-items/form/div/div[4]//span[@class='radio-icon']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc start job loop for ENG partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='clickDocumentNotReady']
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc start job loop for CHN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I set <email> to the inputfield //input[@id='email_id']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc start job loop for JPN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-1-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I click on the element //app-phoenix-plan-items/form/div/div[3]//span[@class='radio-icon']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc start job loop for KOR partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //button[contains(@data-description,'2-1-select') and @angularticslabel='top cta']
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I click on the element //app-phoenix-plan-items/form/div/div[4]//span[@class='radio-icon']
