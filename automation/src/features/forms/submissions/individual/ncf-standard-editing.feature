...
Feature: New User order form submission for Standard Editing

    Background: I am on new user form
        Given I open the eos "/order/ncf" and wait for load

    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in wc loop for ENG partner
        ...
        @eng
        Examples:
            | wordCount | email                    | phone        | file path                          | Type of Document                          | subject area1                         | subject area2            | reference source                   | Success message                       |
            | "5000"    | "enguser@mailinator.com" | "9999999999" | ../../../../data/upload/TEST.docx; | //span[normalize-space()='Annual report'] | //span[normalize-space()='Chemistry'] | //div[text()='Colloids'] | //span[normalize-space()='Google'] | "We'll start work on it immediately!" |

    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in wc loop for CHN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I set <wordCount> to the inputfield //div[@class='input-box']/input
        When I click on the element //div[contains(@class,'enter-word-count')]/button
        ...
        Examples:
            | wordCount | email                    | phone        | file path                          | Type of Document                     | subject area1                         | subject area2            | reference source                     | Success message            |
            | "5000"    | "chnelig@mailinator.com" | "9999999999" | ../../../../data/upload/TEST.docx; | //span[normalize-space()='会议论文'] | //span[normalize-space()='Chemistry'] | //div[text()='Colloids'] | //span[normalize-space()='期刊推荐'] | "我们将立即为您启动服务。" |

    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in wc loop for JPN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I set <wordCount> to the inputfield //div[@class='input-box']/input
        When I click on the element //div[contains(@class,'enter-word-count')]/button
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in wc loop for KOR partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //button[contains(@data-description,'2-36-select') and @angularticslabel='top cta']
        When I set <wordCount> to the inputfield //div[@class='input-box']/input
        When I click on the element //div[contains(@class,'enter-word-count')]/button
        When I click on the element //app-phoenix-plan-items/form/div/div[4]//span[@class='radio-icon']
        When I click on the element //button[@angularticsaction="proceedFromPlanSection"]
        When I click on the element //button[@angularticsaction="proceedFromAddonSection"]
        When I set <first name> to the inputfield //input[@id='field_client_profile_firstname']
        When I set <last name> to the inputfield //input[@id='field_client_profile_lastname']
        ...
        Examples:
            ...
            | "5000"    | "fname"    | "lname"   | "nlname"         | "koruser@mailinator.com" | "9999999999" | "department" | "organization" | //span[normalize-space()='강사'] | ../../../../data/upload/TEST.docx; | //span[normalize-space()='컨퍼런스 발표자료'] | //span[normalize-space()='Chemistry'] | //div[text()='Colloids'] | //span[normalize-space()='PubSURE'] | "Payer name" | "Payer address ABC" | "영업시간 내에 작업과 관련되는 사항이 이메일로 발송될예정이며, 메일함과 스팸메일함을 모두 확인해 주시기 바랍니다." |

    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in skip wc send quote loop for ENG partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='clickDocumentNotReady']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in skip wc send quote loop for CHN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I set <email> to the inputfield //input[@id='email_id']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in skip wc send quote loop for JPN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I click on the element //app-phoenix-plan-items/form/div/div[2]//span[@class='radio-icon']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for Premium editing in skip wc send quote loop fro KOR partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        ...
        When I click on the element //button[@angularticsaction='Submit attempt']
        Then I expect the url to contain "thank-you"
        Then I expect that element //div[contains(@class,'message-section')]/h2[1] matches the text <Success message>

        @kor
        Examples:
            | first name | last name | native last name | email                    | phone        | department   | organization   | job description option           | number | file path                          | Type of Document                              | subject area1                         | subject area2            | reference source                    | payerName    | payerAddress        | Success message                                |
            | "fname"    | "lname"   | "nlname"         | "koruser@mailinator.com" | "9999999999" | "department" | "organization" | //span[normalize-space()='강사'] | 1      | ../../../../data/upload/TEST.docx; | //span[normalize-space()='컨퍼런스 발표자료'] | //span[normalize-space()='Chemistry'] | //div[text()='Colloids'] | //span[normalize-space()='PubSURE'] | "Payer name" | "Payer address ABC" | "에디티지 서비스를 신청해주셔서 감사드립니다." |

    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in skip wc start job loop for ENG partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='clickDocumentNotReady']
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in skip wc start job loop for CHN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I set <email> to the inputfield //input[@id='email_id']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in skip wc start job loop for JPN partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //ul[contains(@class,'compare-table')]//button[contains(@data-description,'2-36-select sl2 top-click-select-editing')]
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I click on the element //app-phoenix-plan-items/form/div/div[2]//span[@class='radio-icon']
    ...
    @sanity
    Scenario Outline: I expect to submit NCF for standard editing in skip wc start job loop for KOR partner
        When I click on the element //a[@href='/order/ncf/english-editing']
        When I click on the element //button[contains(@data-description,'2-36-select') and @angularticslabel='top cta']
        When I click on the element //a[@angularticsaction='iDontKnowWordcount']
        When I click on the element //app-phoenix-plan-items/form/div/div[4]//span[@class='radio-icon']
