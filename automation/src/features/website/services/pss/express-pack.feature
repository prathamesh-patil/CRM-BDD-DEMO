Feature: express pack publication support service

    Background: I am on express pack publication support service
        Given I open the website "/services/publishing-services-packs/express-pack"

    @sanity
    Scenario Outline: I expect that all links on express pack full publication support page should be verified against expectation
