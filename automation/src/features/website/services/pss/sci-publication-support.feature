Feature: Sci publication support service

    Background: I am on sci publication support service
        Given I open the website "/services/publishing-services-packs/sci-publication-support"

    Scenario Outline: I expect that all links on sci publication support page should be verified against expectation
