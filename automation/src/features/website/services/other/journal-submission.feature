Feature: Journal submission service

    Background: I am on journal submission page
        Given I open the website "/services/other/journal-submission"

    @sanity
    Scenario Outline: I expect to open order page on forms on clicking on forms CTA on journal submission page
        ...
        Examples:
            ...
            | /html/body/app-root/ng-component/app-introduction-pearl/section/div/div/div[2]/div[1]/app-lynk/a | "/order/ncf/publication-support-packages/custom-pack?add-ons=journal-submission&source=website" | /html/body/app-root/ng-component/div/section/div/ng-component/div/div/div[2]/div/div/div[1]/div/app-phoenix-order-summary/div/div/div[2]/div[1] | "detail-block"  | /html/body/app-root/ng-component/div/section/div/ng-component/div/div/div[2]/div/div/div[1]/div/app-phoenix-order-summary/div/div/div[2]/div[2]/div[1]/div[1]/span | "Journal Submission" |

    @sanity
    Scenario Outline: I expect to see correct pricing for journal submission service
    ...
    @sanity
    Scenario Outline: I expect to see correct buy now link on journal submission page
        Then I expect that element <element> has the link <link>
        @eng
        Examples:
            | element                                                                                          | link                                                                                            |
            | /html/body/app-root/ng-component/app-introduction-pearl/section/div/div/div[2]/div[1]/app-lynk/a | "/order/ncf/publication-support-packages/custom-pack?add-ons=journal-submission&source=website" |
            | //*[@id="header"]/section/div/app-navigator[2]/div/ul/li[6]/app-lynk/a                           | "/order/ncf/publication-support-packages/custom-pack?add-ons=journal-submission&source=website" |

    Scenario Outline: I expect to see correct links to PSS service on journal submission page
        Then I expect that element <element> has the link <link>
        @eng
        Examples:
            | element                                                                                                                                  | link                                                |
    ...
    Scenario Outline: I expect FAQs should be functional on journal submission page
