Feature: Literature search service

    Background: I am on literature search page
        Given I open the website "/services/other/literature-search"

    @sanity
    Scenario Outline: I expect to see correct buy now link on literature search page
    ...
    Scenario Outline: I expect FAQs should be functional on literature search page
