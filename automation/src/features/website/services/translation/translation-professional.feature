Feature: Professional translation service

    Background: I am on professional translation service
        Given I open the website "/services/translation/professional"

    @sanity
    Scenario Outline: I expect to see correct pricing for professional translation services
        Then I expect that element <element> matches the text <price>
        @chn
        Examples:
            | element                                     | price   |
            | //h2[@class='text-ruby-alpha inline-block'] | "￥0.65" |

    @sanity
    Scenario Outline: I expect that all links on professional translation page should be verified against expectation
        Then I expect that element <element> has the link <link>
        @chn
        Examples:
            | element                                                                                             | link                                                                                                        |
            | /html/body/app-root/ng-component/app-plan-detail/div[2]/div/app-plan-card/div/div/div[4]/app-lynk/a | "/order/ncf/translation-services/simplified-chinese-to-english-translation-standard-editing?source=website" |

    @chn @sanity
    Scenario: I expect the service widget on professional translation page should be functional
        ...
        Then I expect the url to contain "/order/ncf/translation-services/simplified-chinese-to-english-translation-standard-editing"
    ...
    Scenario Outline: I expect the service widget on professional translation page to throw validation in case user enters invalid value in any field
    ...
    Scenario Outline: I expect to open order page on forms on clicking on forms CTA on professional translation page
        ...
        Examples:
            ...
            | //*[@id="header"]/section/div/app-navigator[2]/div/ul/li[8]/app-lynk/a                              | "/order/ncf/translation-services/simplified-chinese-to-english-translation-standard-editing?source=website" | /html/body/app-root/ng-component/div/section/div/ng-component/div/div/div[2]/div/div/div[1]/div/div[1]/app-phoenix-document/div/section/div[1]/div[1]/div[1]/div[2]/button | "btn-primary-blue" |
            | /html/body/app-root/ng-component/app-plan-detail/div[2]/div/app-plan-card/div/div/div[4]/app-lynk/a | "/order/ncf/translation-services/simplified-chinese-to-english-translation-standard-editing?source=website" | /html/body/app-root/ng-component/div/section/div/ng-component/div/div/div[2]/div/div/div[1]/div/div[1]/app-phoenix-document/div/section/div[1]/div[1]/div[1]/div[2]/button | "btn-primary-blue" |

    @sanity
    Scenario Outline: I expect to open order page on forms on clicking on forms tabs on professional translation page
        ...
        Examples:
            ...
            | /html/body/app-root/ng-component/app-pricing-block-ruby/section/div/div/div/div[1]/span[1] | /html/body/app-root/ng-component/app-pricing-block-ruby/section/div/div/div/div[3]/div[2]/app-lynk/a | "/order/ncf/translation-services/simplified-chinese-to-english-translation-premium-editing?source=website" | /html/body/app-root/ng-component/div/section/div/ng-component/div/div/div[2]/div/div/div[1]/div/div[1]/app-phoenix-add-on/div[1]/div/div[2]/button | "btn-primary-blue" |
            ...
            | /html/body/app-root/ng-component/app-pricing-block-ruby/section/div/div/div/div[1]/span[6] | /html/body/app-root/ng-component/app-pricing-block-ruby/section/div/div/div/div[3]/div/app-lynk/a    | "/order/ncf/translation-services/simplified-chinese-to-english-translation-premium-editing?source=website" | /html/body/app-root/ng-component/div/section/div/ng-component/div/div/div[2]/div/div/div[1]/div/div[1]/app-phoenix-add-on/div[1]/div/div[2]/button | "btn-primary-blue" |

    @chn
    Scenario: I expect to verify the h1 tags on professional translation page
