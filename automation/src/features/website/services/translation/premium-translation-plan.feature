Feature: Premium translation plan service

    Background: I am on premium translation plan service
        Given I open the website "/services/translation/premium-translation-plan"

    @sanity
    Scenario Outline: I expect that all links on premium translation plan page should be verified against expectation
        ...
        Examples:
            ...
            | /html/body/app-root/ng-component/app-plan-detail/div[2]/div/app-plan-card/div/div/div[6]/app-lynk/a           | "/order/ncf/j2e-translation-services/premium-translation?source=website" |
            | /html/body/app-root/ng-component/app-featured-block-lapis/div[2]/div/div/div[2]/app-lynk/a                    | "/order/ncf/j2e-translation-services/premium-translation?source=website" |
            | /html/body/app-root/ng-component/app-service-pitch-ruby[2]/div[2]/div/div[1]/div/div[2]/div[2]/div/app-lynk/a | "/services/translation/top-journal-translation-plan"                     |
            | //*[@id="header"]/section/div/app-navigator[2]/div/ul/li[4]/app-lynk/a                                        | "/order/ncf/j2e-translation-services/premium-translation?source=website" |
            | /html/body/app-root/ng-component/app-service-pitch-ruby[1]/div[2]/div/div[1]/div/div[2]/div[2]/div/app-lynk/a | "/info/ppc/thesis-translation/"                                          |
        ...
        Examples:
            ...
            | /html/body/app-root/ng-component/app-custom-quote-block-ruby/section/div[1]/div/div[1]/div[3]/app-lynk[1]/a | "/services/translation/general-plans"             |
            | /html/body/app-root/ng-component/app-custom-quote-block-ruby/section/div[1]/div/div[2]/div[3]/app-lynk[1]/a | "/services/translation/large-projects-plans"      |



    Scenario Outline: I expect FAQs should be functional on premium translation plan page
    ...
    @sanity
    Scenario Outline: I expect to open order page on forms on clicking on forms CTA on premium translation page
        ...
        Examples:
            ...
            | //*[@id="header"]/section/div/app-navigator[2]/div/ul/li[4]/app-lynk/a                              | "/order/ncf/j2e-translation-services/premium-translation?source=website" | //*[@id="prospect"]/div/div/div/div/div/button | "btn-primary-blue" |
            | /html/body/app-root/ng-component/app-plan-detail/div[2]/div/app-plan-card/div/div/div[6]/app-lynk/a | "/order/ncf/j2e-translation-services/premium-translation?source=website" | //*[@id="prospect"]/div/div/div/div/div/button | "btn-primary-blue" |


    Scenario Outline: I expect to open order page on forms on clicking on forms tabs on premium translation page
