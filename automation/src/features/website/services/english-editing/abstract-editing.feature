Feature: Abstract editing

    Background: I am on abstract editing page
        Given I open the website "/services/english-editing/abstract-editing"

    @sanity
    Scenario Outline: I expect to open service page on forms by clicking on forms CTA on abstract editing page
        ...
        Examples:
            ...
            | //*[@id="header"]/section/div/app-navigator[2]/div/ul/li[6]/app-lynk/a                                                                      | "/order/ncf/english-editing/standard-editing/document?coupon=ABSTRACT10&source=website" | //a[@data-description="ncf-screen 3-36-upload document-click-I dont have document ready-null"]                                     | "text-underline-hover" |
            | /html/body/app-root/ng-component/app-introduction-pearl/section/div/div/div[1]/div/app-lynk/a                                               | "/order/ncf/english-editing/standard-editing/document?coupon=ABSTRACT10&source=website" | //a[@data-description="ncf-screen 3-36-upload document-click-I dont have document ready-null"]                                     | "text-underline-hover" |
    ...
    @sanity
    Scenario Outline: I expect that all links on abstract editing page should be verified against expectation
        Then I expect that element <path> has the link <link>
        @eng
        Examples:
            | link               | path                                                                                        |
    ...
    Scenario Outline: I expect FAQs should be functional on abstract editing page
