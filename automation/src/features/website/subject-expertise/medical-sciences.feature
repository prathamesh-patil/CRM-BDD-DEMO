Feature: Medical Science Subject expertise

    Background: I am on medical science subject expertise page
        Given I open the website "/subject-expertise/medical-sciences"

    @sanity
    Scenario Outline: I expect that all links on medical science subject expertise page should be verified against expectation
    ...
    Scenario Outline: I expect to open forms tabs CTA on clicking plan cards in the medical science subject expertise page
