# @author sherin
Feature: Life Science Subject expertise

    Background: I am on life science subject expertise page
        Given I open the website "/subject-expertise/life-sciences"

    @sanity
    Scenario Outline: I expect that all links on life science subject expertise page should be verified against expectation
    ...
    @sanity
    Scenario Outline: I expect to open forms page on clicking plan cards CTA on life science subject expertise page
