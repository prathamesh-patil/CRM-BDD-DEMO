Feature: Physical Science & Engineering Subject expertise

    Background: I am on physical science & engineering subject expertise page
        Given I open the website "/subject-expertise/physical-science-and-engineering"

    @sanity @smoke
    Scenario Outline: I expect that all links on physical science & engineering subject expertise page should be verified against expectation
    ...
    @sanity
    Scenario Outline: I expect to open order page forms page on clicking plan cards CTA  in the physical science & engineering subject expertise page
