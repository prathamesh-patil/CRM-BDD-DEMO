# @author sherin
Feature: Humanities & Social Sciences Subject expertise

    Background: I am on humanities and social sciences subject expertise page
        Given I open the website "/subject-expertise/humanities-and-social-sciences"

    @sanity
    Scenario Outline: I expect that all links on humanities and social sciences subject expertise page should be verified against expectation
        ...
        Examples:
            ...
            | //app-compare-services//a          | "/order/ncf" |
    @sanity
    Scenario Outline: I expect to open forms page on clicking plan cards CTA  in the humanities and social sciences subject expertise page
