Feature: Subject expertise chemistry sample

    Background: I am on subject expertise chemistry sample page
        Given I open the website "/subject-expertise-samples/chemistry"

    @sanity
    Scenario Outline: I expect that all links on subject expertise chemistry sample page should be verified against expectation
    ...
    @sanity
    Scenario Outline: I expect to open service page on forms by clicking on forms CTA on subject expertise chemistry samples page
    ...
    Scenario Outline: I expect FAQs should be functional on subject expertise chemistry samples page
