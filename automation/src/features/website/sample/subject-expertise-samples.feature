Feature: Subject expertise samples

    Background: I am on subject expertise chemistry sample page
        Given I open the website "/subject-expertise-samples"

    @sanity
    Scenario Outline: I expect that all links on subject expertise samples page should be verified against expectation
    ...
    Scenario Outline: I expect FAQs should be functional on subject expertise samples page
