Feature: Subject expertise molecular biology sample

    Background: I am on subject expertise molecular biology sample page
        Given I open the website "/subject-expertise-samples/molecular-biology"

    @sanity
    Scenario Outline: I expect that all links on subject expertise molecular biology sample page should be verified against expectation
    ...
    @sanity
    Scenario Outline: I expect to open service page on forms by clicking on forms CTA on subject expertise molecular biology sample page
    ...
    Scenario Outline: I expect FAQs should be functional on subject expertise molecular biology sample page
