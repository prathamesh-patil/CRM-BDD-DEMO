Feature: Subject expertise economics and statistics sample

    Background: I am on subject expertise economics and statistics sample page
        Given I open the website "/subject-expertise-samples/economics-and-statistics"

    @sanity
    Scenario Outline: I expect that all links on subject expertise sample economics and statistics page should be verified against expectation
        ...
        Examples:
            ...
            | /html/body/app-root/ng-component/app-service-sample-ruby[3]/div/div/div/div[2]/app-lynk[1]/a                                             | "/services/english-editing/top-journal-editing-plan"                |
    ...
    @sanity
    Scenario Outline: I expect to open service page on forms by clicking on forms CTA on subject expertise economics and statistics sample
        ...
        Examples:
            ...
            | /html/body/app-root/ng-component/app-service-sample-ruby[3]/div/div/div/div[2]/app-lynk[2]/a | "/order/ncf/english-editing?source=website" | /html/body/app-root/ng-component/div/section/div/ng-component/ng-component/div/div[2]/div[1]/ul/li[2]/div[1]/h3 | "comp-head"     |
    ...
    Scenario Outline: I expect FAQs should be functional on subject expertise economics and statistics sample
