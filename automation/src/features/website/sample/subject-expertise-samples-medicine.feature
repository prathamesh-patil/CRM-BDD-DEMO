Feature: Subject expertise medicine sample

    Background: I am on subject expertise medicine sample page
        Given I open the website "/subject-expertise-samples/medicine"

    @sanity
    Scenario Outline: I expect that all links on subject expertise medicine sample page should be verified against expectation
    ...
    @sanity
    Scenario Outline: I expect to open service page on forms by clicking on forms CTA on subject expertise medicine sample page
    ...
    Scenario Outline: I expect FAQs should be functional on subject expertise medicine sample page
