Feature: English to Japanase service translation sample

    Background: I am on english to japanses service translation sample page
        Given I open the website "/services/translation/english-to-japanese/sample"

    @sanity
    Scenario Outline: I expect that all links on english to japanese translation service sample page should be verified against expectation
        Then I expect that element <element> has the link <link>
        @jpn
        Examples:
            | element                                                                                                                                     | link                                                                        |
            | //*[@id="header"]/section/div/app-navigator[2]/div/ul/li[4]/app-lynk/a                                                                      | "/order/ncf/translation-services?ss=e2j&ss=e2j&ss=j2e&pd=js&source=website" |
            ...
            | /html/body/app-root/ng-component/app-service-note-ruby/div/div/div[2]/div[2]/app-lynk[2]/a                                                  | "/order/ncf/translation-services?ss=e2j&ss=e2j&ss=j2e&pd=js&source=website" |
            | /html/body/app-root/ng-component/app-subject-area-opal/section/div/div/div[1]/div[2]/app-subject-area-list/section/div[1]/div[3]/app-lynk/a | "/services/translation/english-to-japanese/sample/medicine"                 |
